	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {	//validazione del prezzo
    		...
    		if (prezzoNum < 0) { //validazione del prezzo
        		...
        		RequestDispatcher rd = request.getRequestDispatcher("/DashboardAdminServlet"); //reindirizzamento alla pagina di errore
		...
		if(!contentType.equals("image/jpeg") && !contentType.equals("image/png") && !contentType.equals("image/jpg")) {  //validazione del tipo di contenuto
		...
		String pathImgDB = "img/prodotti/"+fileNameLower; //percorso di salvataggio del file nel DB
		...
		String pathImgFile = uploadPath+"/"+fileNameLower; //percorso del file nel file system
