                    ...
                    <% if (listaProdotti != null && !listaProdotti.isEmpty()) { %>
                        <% for (ProdottoBean prodotto : listaProdotti) { %>
                            <tr>
                                ...
                                <td>
                                    <a href="${pageContext.request.contextPath}/ModificaProdottoServlet?id=<%= prodotto.getIdProdotto() %>" class="admin-btn-edit">Modifica</a>
                                    <a href="${pageContext.request.contextPath}/EliminaProdottoServlet?id=<%= prodotto.getIdProdotto() %>" class="admin-btn-delete">Elimina</a>
                                </td>
                            </tr>
                        <% } %>
                    <% } else { %>
