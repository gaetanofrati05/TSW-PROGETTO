        ...
        <div class="login-card-luxury">
            ...
            <form  id="formRegistrazione"action="${pageContext.request.contextPath}/RegistrazioneServlet" method="POST">
                ...
                <div class="form-group">
                    ...
                    <span id="nazionalita-error" class="js-error" style="color: var(--oro); display: none;">Prefisso non valido</span>
                </div>
                ...
                <div class="form-group">
                    ...
                    <span id="password-error1" class="js-error" style="color: var(--oro); display: none;">Password non valida</span>
                </div>
                
                 <div class="form-group">
                    <label class="form-label required-label" for="confermaPassword">Password</label>
                    <div class="input-password-wrapper">
                        <input type="password" id="confermaPassword" name="confermaPassword" placeholder="Conferma la tua password" required class="custom-input">
                        <button type="button" class="toggle-pwd-btn" aria-label="Mostra password">
                            <i class="ti ti-eye toggle-pwd-icon" aria-hidden="true"></i>
                        </button>
                    </div>
                    <span id="password-error2" class="js-error" style="color: var(--oro); display: none;">Password non valida</span>
                </div>
